...
## ----fake_data_for_comparing_trees, echo=FALSE---------------------------
set.seed(291)
ss <- sample(120, 4)
...
## ----dend1_plot_1, echo=FALSE, fig.height=9------------------------------
...
## ----tanglegram_dend12_1, echo=FALSE, fig.height=9, fig.width=10---------
...
## ----, fig.width=9, fig.height=9, echo=FALSE-----------------------------
