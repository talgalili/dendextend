...
# cutree now works for unrooted trees!
...
microbenchmark(
   cutree_unroot_dend = cutree(unroot_dend, k=2:4, warn = FALSE),
   cutree_unroot_dend_not_trying_to_hclust = 
      cutree(unroot_dend, k=2:4, try_cutree_hclust=FALSE, warn = FALSE)
)
