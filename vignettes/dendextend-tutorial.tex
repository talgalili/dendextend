...
THE FM index is also available through the \code{pci} function, in the \pkg{profdpm} package \citep{CRAN:profdpm}.

\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{our_dist} \hlkwb{<-} \hlkwd{dist}\hlstd{(USArrests[}\hlnum{1}\hlopt{:}\hlnum{10}\hlstd{, ])}
\hlstd{dend1} \hlkwb{<-} \hlkwd{hclust}\hlstd{(our_dist,} \hlstr{"complete"}\hlstd{)}
\hlstd{dend2} \hlkwb{<-} \hlkwd{hclust}\hlstd{(our_dist,} \hlstr{"single"}\hlstd{)}

\hlkwd{require}\hlstd{(}\hlstr{"profdpm"}\hlstd{)}  \hlcom{# see page 9 and 10:}
\hlkwd{pci}\hlstd{(}\hlkwd{cutree}\hlstd{(dend1,} \hlkwc{k} \hlstd{=} \hlnum{4}\hlstd{),} \hlkwd{cutree}\hlstd{(dend2,} \hlkwc{k} \hlstd{=} \hlnum{4}\hlstd{))[}\hlnum{2}\hlstd{]}
\end{alltt}
\begin{verbatim}
##     FM 
## 0.5833
\end{verbatim}
\begin{alltt}
\hlkwd{Bk}\hlstd{(dend1, dend2,} \hlkwc{k} \hlstd{=} \hlnum{4}\hlstd{)}
\end{alltt}
\begin{verbatim}
## $`4`
## [1] 0.5833
...
##  [5] codetools_0.2-8      dendextendRcpp_0.2.0
##  [7] Rcpp_0.10.4          dendextend_0.9.1    
