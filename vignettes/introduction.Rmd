...
TODO: explain depth first

Many of the functions in dendextend work using a Depth-first search. [Depth-first search](http://en.wikipedia.org/wiki/Depth-first_search) (DFS) is an algorithm for traversing or searching tree or graph data structures. One starts at the root and explores as far as possible along each branch before backtracking. Here is an illustration of this ordering for a simple tree:
