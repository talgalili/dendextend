...
Here is a plot of the tree, and the order in which you should read the "nodes attributes":
...
dend %>% get_nodes_attr("midpoint") # how much "left" is this node from its left-most child
...
TODO: `rect.dendrogram`


### Exploring a dendrogram's basic parameters
