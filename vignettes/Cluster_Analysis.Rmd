...
There are also several other subtrees which are identical between the two methods. The biggest diffence lies in several "rougue" states which are placed differently in the two clustering algorithms. They are: Vermont, Michigan, Maine, Hawaii, New Jersey, West Virinia, and Oklahoma.
...
4. The (mostly) warm-blooded vertebrates, without hair, some can fly, and some aren endangered.
